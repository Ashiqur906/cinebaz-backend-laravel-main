...
class SslCommerzPaymentController extends Controller
{
    ...
    public function payViaAjax(Request $request)
    {
        ...
        $total_ammount  = $cartTotal;

        $post_data = array();
        $post_data['total_amount'] = $total_ammount; # You cant not pay less than 10
        $post_data['currency'] = "BDT";
        $post_data['tran_id'] = uniqid(); // tran_id must be unique

        # CUSTOMER INFORMATION
        $post_data['cus_name'] = $member->name;
        $post_data['cus_email'] = $member->email;
        $post_data['cus_add1'] = "Customer Address";
        $post_data['cus_add2'] = "";
        $post_data['cus_city'] = "";
        $post_data['cus_state'] = "";
        $post_data['cus_postcode'] = "";
        $post_data['cus_country'] = "Bangladesh";
        $post_data['cus_phone'] = $member->phone;
        $post_data['cus_fax'] = "";
        ...
        $post_data['shipping_method'] = "NO";
        $post_data['product_name'] = 'Buy Ticket';
        ...
        $create = new Order(); 
        $create->code              = $code;
        $create->name              = $post_data['cus_name'];
        $create->email             = $post_data['cus_email'];
        $create->phone             = $post_data['cus_phone'];
        $create->amount            = $post_data['total_amount'];
        $create->status            = 'Pending';
        $create->member_id         = $member->id;
        $create->sub_status        = 'Active';
        $create->address           = $member->address;
        $create->transaction_id    = $post_data['tran_id'];
        $create->currency          = $post_data['currency'];               
        $create->save();

        foreach($cartCollection as $myCart){
            $createChild = new OrderDetails();
            $createChild->order_id      = $create;

...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.lazyload/1.9.1/jquery.lazyload.js"></script>
    ...
    <section id="home" class="iq-main-slider p-0">
        <div id="home-slider" class="slider m-0 p-0">
            ...
            <div class="slide slick-bg s-bg-1" style="background-image:url('{{asset( $slider->featuredL ? 'storage/'.$slider->featuredL->full : 'https://cdn.designcrowd.com/blog/2018/March/50-Typographic-Oscars-Film-Posters/GR_Typographic-Oscar-Film-Posters_Banner_828x300.jpg' )}}') !important">
                        ...
                        <div class="row align-items-center  h-100">
                            <div class="col-xl-6 col-lg-12 col-md-12">
                                ...
                                <div class="d-flex align-items-center r-mb-23" data-animation-in="fadeInUp"
                                    data-delay-in="1.2">
                                    <a href="{{ route('frontend.details', $slider->slug) }}" class="btn btn-hover"><i class="fa fa-play mr-2"
                                            aria-hidden="true"></i>Play Now</a>
                                    @if ($slider->details_button_url)
                                        <a href="{{ $slider->details_button_url }}" class="btn btn-link">
    ...
    <div class="main-content">
        @foreach ($categories as $key =>  $list)
            @include('frontend::layouts.part.slider_category',['slider' => ['data' => $list->medias, 'name' => $list->title_english,'cat_id' => $list->id]])
        @endforeach
    </div>

...
@if(count($slider) > 0)
@if(count($slider)>0)
<section id="parallex" class="parallax-window" style="background-image:url('{{ asset($slider[0]->image)}}')">
@else
<section id="parallex" class="parallax-window" style="background-image:url('{{ asset('frontend/images/parallax/p1.jpg') }}')">
@endif

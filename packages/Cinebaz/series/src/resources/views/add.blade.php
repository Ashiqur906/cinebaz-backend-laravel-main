        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    {{ Form::open(['method' => 'POST', 'route' => 'admin.series.store']) }}
                    <div class="row">
                        <div class="col-md-9">
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('title_bn', !empty($fdata->title_bn) ? $fdata->title_bn : null, ['id' => 'title_bn', 'class' => $errors->has('title_bn') ? 'form-control is-invalid' : 'form-control', 'placeholder' => 'Title Bangla']) }}
                                        @error('title_bn')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        {{ Form::label('title_bn', 'Title Hindi') }}

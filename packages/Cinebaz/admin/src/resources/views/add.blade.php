                    ...
                    <form class="mt-4" method="POST" action="{{ route('admin.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-lg-4 mb-3">
                                ...
                                <img src="{{asset(auth('web')->user()->images[0]->small)}}" class="img-fluid d-block mx-auto mb-3" alt="{{auth('web')->user()->name}}" id="p_image">
                                @else
                                ...
                                @endif
                                <h4 class="mb-3">{{auth('web')->user()->name}}</h4>
                                ...
                                {{ Form::hidden('id',auth('web')->user()->id ) }}
                            </div>
                            <div class="col-lg-8">
                                <div class="sign-user_card">
                                    ...
                                    <div class="row align-items-center justify-content-between mb-3">
                                        <div class="col-md-12">
                                            ...
                                            {{ Form::text('name',auth('web')->user()->name , ['id' => 'name', 'class' => $errors->has('name') ? 'form-control is-invalid' : 'form-control', 'placeholder' => 'Your Name']) }}
                                            @error('name')
                                    ...
                                    <div class="row align-items-center justify-content-between mb-3">
                                        <div class="col-md-12">
                                            ...
                                            {{ Form::text('email',auth('web')->user()->email , ['id' => 'email', 'class' => $errors->has('email') ? 'form-control is-invalid' : 'form-control', 'placeholder' => 'Your Email']) }}
                                            @error('email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>

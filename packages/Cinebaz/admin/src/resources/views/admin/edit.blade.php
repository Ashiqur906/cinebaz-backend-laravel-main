...
<div id="content-page" class="content-page">
   <div class="container-fluid">
         <div class="row">
               <div class="col-sm-12">
                    <form class="mt-4" method="POST" action="{{ route('admin.update') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-4 mb-3">
                                @if(count($admin->images) > 0)
                                <img src="{{asset($admin->images[0]->small)}}" class="img-fluid d-block mx-auto mb-3" alt="{{$admin->name}}" id="p_image">
                                @else
                                <img src="https://visualpharm.com/assets/30/User-595b40b85ba036ed117da56f.svg" class="img-fluid d-block mx-auto mb-3" alt="{{$admin->name}}" id="p_image">
                                @endif
                                ...
                                <div class="sign-user_card">
                                    ...
                                    <div class="row align-items-center justify-content-between mb-3">
                                        <div class="col-md-12">
                                            ...
                                            {{ Form::text('name',$admin->name , ['id' => 'name', 'class' => $errors->has('name') ? 'form-control is-invalid' : 'form-control', 'placeholder' => 'Your Name']) }}
                                            @error('name')
                                    ...
                                    <div class="row align-items-center justify-content-between mb-3">
                                        <div class="col-md-12">
                                            ...
                                            {{ Form::text('email',$admin->email , ['id' => 'email', 'class' => $errors->has('email') ? 'form-control is-invalid' : 'form-control', 'placeholder' => 'Your Email']) }}
                                            @error('email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <!-- <div class="row align-items-center justify-content-between mb-3">
                                        <div class="col-md-12">
                                            ...
                                            {{ Form::text('phone',auth('web')->user()->phone , ['id' => 'email', 'class' => $errors->has('phone') ? 'form-control is-invalid' : 'form-control', 'placeholder' => 'Your Phone']) }}
                                            @error('phone')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>

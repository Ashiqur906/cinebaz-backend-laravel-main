                           ...
                           <td>
                              <div class="flex align-items-center list-user-action">
                                 ...
                                 <a class="iq-bg-info" data-toggle="tooltip" data-placement="top" title=""
                                    data-original-title="Edit" href="{{route('admin.profile.edit',['user_id'=>$admin->id])}}"><i class="lar la-edit"></i></a>
                                  
                                 <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title=""
                                    data-original-title="Delete" href="{{route('admin.delete',$admin->id)}}" onclick="return confirm('Are you sure you want to delete this Admin ?');"><i
